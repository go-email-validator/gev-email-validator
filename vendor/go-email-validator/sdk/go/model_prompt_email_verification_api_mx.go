...
// PromptEmailVerificationApiMX struct for PromptEmailVerificationApiMX
...
func NewPromptEmailVerificationApiMX() *PromptEmailVerificationApiMX {
	this := PromptEmailVerificationApiMX{}
	return &this
}
...
func (o PromptEmailVerificationApiMX) MarshalJSON() ([]byte, error) {
...
type NullablePromptEmailVerificationApiMX struct {
	value *PromptEmailVerificationApiMX
	isSet bool
}

func (v NullablePromptEmailVerificationApiMX) Get() *PromptEmailVerificationApiMX {
	return v.value
}

func (v *NullablePromptEmailVerificationApiMX) Set(val *PromptEmailVerificationApiMX) {
	v.value = val
	v.isSet = true
}

func (v NullablePromptEmailVerificationApiMX) IsSet() bool {
	return v.isSet
}

func (v *NullablePromptEmailVerificationApiMX) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromptEmailVerificationApiMX(val *PromptEmailVerificationApiMX) *NullablePromptEmailVerificationApiMX {
	return &NullablePromptEmailVerificationApiMX{value: val, isSet: true}
}

func (v NullablePromptEmailVerificationApiMX) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromptEmailVerificationApiMX) UnmarshalJSON(src []byte) error {
	v.isSet = true
